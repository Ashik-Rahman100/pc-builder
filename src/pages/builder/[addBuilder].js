import { addComponent } from "@/redux/features/builderSlice";
...
//   console.log("category ==>",category)
  ...
  const handleAddToBuilder = (selectedCategory, selectedComponent) => {
    dispatch(
      addComponent({ category: selectedCategory, component: selectedComponent })
    );
    ...
    <div className="min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 justify-items-center">
        {filteredProducts?.map((product) => (
          <div key={product.id} className="card w-96 glass">
            <figure>
            ...
            <div className="card-body">
              ...
              <div className="card-actions">
                <Link
                  href={`/pc-builder`}
                  onClick={() => handleAddToBuilder(category, product)}
